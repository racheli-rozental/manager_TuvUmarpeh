...
// //             <p>Date: {activity.dateActivity}</p>
// //             <p>Description: {activity.detailsActivity}</p>
// //             <p>Max Participants: {activity.max}</p>
...
//             <Paper elevation={3} sx={{ padding: '20px', borderRadius: '8px', boxShadow: '0 4px 10px rgba(0, 0, 0, 0.1)' }}>
//                 {/* כותרת */}
//                 <Typography variant="h4" component="h2" color="primary" fontWeight={600} gutterBottom>
